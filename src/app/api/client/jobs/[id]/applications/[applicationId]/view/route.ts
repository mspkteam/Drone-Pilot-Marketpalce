...
import { markJobApplicationViewed } from "@/lib/applications/client-offers";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  const result = await markJobApplicationViewed(
    jobId,
    applicationId,
  ...
  return NextResponse.json({ ok: true, clientViewedAt: result.clientViewedAt });
}
