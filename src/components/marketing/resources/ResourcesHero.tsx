export function ResourcesHero() {
  return (
    <section className="figma-resources-hero relative overflow-hidden border-b border-[rgba(218,176,65,0.12)]">
      <div
      ...
      <div className="public-container relative py-24 sm:py-28 lg:py-32">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-4xl font-extrabold leading-[1.05] tracking-tight text-ras-text sm:text-5xl lg:text-[3.25rem] lg:leading-[1.08]">
            Drone Resources, Guides, and{" "}
            <span className="text-gold">Industry Insights</span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-[1.7] text-ras-warm sm:text-lg">
            Learn how to hire drone pilots, understand drone regulations, plan
            projects, and grow as a professional pilot.
          </p>
        </div>
      </div>
    </section>
