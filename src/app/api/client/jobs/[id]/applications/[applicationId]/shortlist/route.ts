...
import { toggleJobApplicationShortlist } from "@/lib/applications/client-offers";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  const result = await toggleJobApplicationShortlist(
    jobId,
    applicationId,
  ...
  return NextResponse.json({ ok: true, shortlisted: result.shortlisted });
}
