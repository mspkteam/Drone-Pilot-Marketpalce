import type { DashboardNavIconId } from "@/types/dashboard-nav";
...
export function DashboardNavIcon({ icon, className }: DashboardNavIconProps) {
  switch (icon) {
    case "dashboard":
      return (
    ...
    case "payments":
      return (
        <IconBase className={className}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.25h6a2.25 2.25 0 100-4.5h-3a2.25 2.25 0 110-4.5h6" />
        </IconBase>
      );
    case "membership":
    case "subscriptions":
    ...
    case "achievements":
      return (
        <IconBase className={className}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 3l2.5 6.5L21 11l-5 4.5L17 21l-5-3-5 3 1-5.5L3 11l6.5-1.5L12 3z" />
        </IconBase>
      );
    case "certificates":
      return (
    ...
    case "bookings":
      return (
        <IconBase className={className}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.945.393 2.64 1.086.695.694 1.086 1.627 1.086 2.64v9.75A2.25 2.25 0 0116.5 21h-9a2.25 2.25 0 01-2.25-2.25v-9.75z" />
        </IconBase>
      );
    case "reports":
      return (
