export function PrivacyHero() {
  return (
    <section className="figma-privacy-hero relative overflow-hidden border-b border-[rgba(218,176,65,0.12)]">
      <div
      ...
      <div className="public-container relative py-24 sm:py-28 lg:py-32">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-xl text-base leading-[1.7] text-ras-muted sm:text-lg">
            Your privacy matters. This page explains how Remote Air Service
