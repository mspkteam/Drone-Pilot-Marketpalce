...
| 6 | Active Contracts | [`808:19635`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-19635) | `/dashboard/pilot/contracts` | **High** | **UI implemented** | Delivery handoff; live bookings |
| 7 | Messages | [`808:20108`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-20108) | `/dashboard/pilot/messages` | Medium | **UI implemented** | Client-initiated threads; job context in header |
...
| 11b | Instructor Membership | [`808:3626`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-3626) | `/dashboard/pilot/instructor` | **High** | **UI implemented** | $199.99 add-on, discount code, student wings |
