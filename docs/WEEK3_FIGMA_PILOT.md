...
| 5 | new PROPOSAL SUBMISSION | [`1171:4339`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=1171-4339) | `/dashboard/pilot/jobs/[id]/proposal` | **High** | Pending review | Newer extended bid form (prefer over older `808:*` frames) |
...
| 8 | Profile | [`808:19119`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-19119) / Main [`808:19441`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-19441) | `/dashboard/pilot/profile` | Medium | **UI implemented** (Main) | Call sign / equipment chips local until schema |
| 9 | Portfolio | [`808:21065`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-21065) | `/dashboard/pilot/portfolio` | Medium | **Nav locked (Week 4)** | Resume tomorrow |
| 10 | reviews | [`808:23642`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-23642) | `/dashboard/pilot/reviews` | Medium | **Nav locked (Week 4)** | Resume tomorrow |
| 11 | Membership | [`1160:4704`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=1160-4704) / Main [`1160:4705`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=1160-4705) | `/dashboard/pilot/subscription` | **High** | **UI done; nav locked (Week 4)** | Pause — unlock when resuming |
| 12 | Uniform | [`808:22234`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-22234) | `/dashboard/pilot/shop` | Low | **Nav locked (Week 4)** | Stripe later |
| 13 | Support | [`808:22755`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-22755) | `/dashboard/pilot/support` | Low | **Nav locked (Week 4)** | Resume tomorrow |
| 14 | SETTINGS | [`808:23194`](https://www.figma.com/design/6E3XlFsDuajsjYjf4LiOPZ/remote-air-service?node-id=808-23194) | `/dashboard/pilot/settings` | Medium | **Nav locked (Week 4)** | Resume tomorrow |

**Also check (may sit outside the main row):** Verifications, Earnings/Payments, Certificates, Achievements — confirm with product if separate Figma frames exist.
